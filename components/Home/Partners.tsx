    ...
    <section className="py-20 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 mb-12">
        <div className="text-center">
          ...
          <p className="font-sans text-[#44618b]">World-class accommodations for unforgettable stays</p>
        </div>
      </div>
      ...
      <div className="relative">
        <div className="partners-track flex" style={{ width: 'max-content' }}>
          {[...hotelPartners, ...hotelPartners].map((partner, index) => (
            <div
              key={index}
              className="flex-shrink-0 mx-4 px-12 py-8 bg-white rounded-xl border border-[#12103d]/10 hover:bg-[#12103d]/5 hover:border-[#d19457]/30 transition-all"
            >
              <span className="font-display text-xl text-[#44618b] whitespace-nowrap">{partner}</span>
            </div>
          ))}
        </div>
      </div>
